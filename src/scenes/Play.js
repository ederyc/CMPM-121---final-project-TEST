class Play extends Phaser.Scene 
{
    ...
    create() {
        ...
        const touchZones = {
            ...
            incrementTime: this.add.zone(this.cameras.main.worldView.centerX, this.cameras.main.worldView.centerY + 200, 100, 100).setOrigin(0.5).setScrollFactor(0)
        };
    ...
    this.add.rectangle(this.cameras.main.worldView.centerX - 300, this.cameras.main.worldView.centerY + 200, 100, 100, 0x00ffff, 0.3).setOrigin(0.5).setScrollFactor(0); // Plant
    this.add.rectangle(this.cameras.main.worldView.centerX + 300, this.cameras.main.worldView.centerY + 200, 100, 100, 0xff00ff, 0.3).setOrigin(0.5).setScrollFactor(0); // Reap
    this.add.rectangle(this.cameras.main.worldView.centerX, this.cameras.main.worldView.centerY + 200, 100, 100, 0x000000, 0.3).setOrigin(0.5).setScrollFactor(0); // incrementTime
    }
